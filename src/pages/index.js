      ...
      <div>
        <main className="max-w-6xl mx-auto bg-white mt-[-6rem] px-8 md:px-24 text-center relative">
          <section className="text-center">
            <h2 className="font-bold text-4xl text-brown uppercase py-20">
              <span className="text-lg text-beige">Conoce más</span> <br />{" "}
              sobre nosotros
            </h2>
          ...
          <section className=" mt-20 ">
            <ul className="grid gap-8 md:grid-cols-[repeat(3,1fr)] [&>li>p]:font-thin [&>li>p]:text-3xl ">
              <li>
                <StaticImage
              ...
              <li>
                <StaticImage src="../images/img/icono_te.svg" alt="icono té" />
                <p>Té</p>
              </li>
            </ul>
          </section>
